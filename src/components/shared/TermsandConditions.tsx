...
const sections = [
  { title: "Agreement", id: "agreement" },
  { title: "Our Services", id: "services" },
  { title: "Intellectual Property Rights", id: "intellectual-property" },
  { title: "User Representations", id: "user-representations" },
  { title: "Purchases and Payment", id: "purchases" },
  { title: "Subscriptions", id: "subscriptions" },
  { title: "Prohibited Activities", id: "prohibited-activities" },
  { title: "User Generated Contributions", id: "user-contributions" },
  ...
  { title: "Term and Termination", id: "term-termination" },
  { title: "Modifications and Interruptions", id: "modifications" },
  ...
  { title: "Limitations of Liability", id: "liability" },
  { title: "Indemnification", id: "indemnification" },
  { title: "User Data", id: "user-data" },
  { title: "Electronic Communications", id: "communications" },
...
const TermsAndConditions: React.FC = () => {
  ...
  return (
    ...
    <div className="bg-white min-h-screen">
      {/* Header */}
      <div className="w-full bg-gray-50 py-8 px-4 sm:px-6 lg:px-8 border-b border-gray-200">
      ...
      <div className="lg:hidden sticky top-0 z-10 bg-white border-b border-gray-200">
        <button
          ...
          className="flex items-center justify-between w-full px-4 py-3 bg-white text-gray-900"
        >
        ...
        {isMenuOpen && (
          <div className="bg-white border-t border-gray-100 max-h-[60vh] overflow-y-auto">
            <ul>
      ...
      <div className="flex">
        {/* Desktop Navigation */}
        <nav className="hidden lg:block sticky top-24 h-[calc(100vh-6rem)] overflow-y-auto p-4 w-64 bg-white border-r border-gray-200">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            {/* Agreement Section */}
            <section id="agreement" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">AGREEMENT TO OUR LEGAL TERMS</h2>
            ...
            {/* Services Section */}
            <section id="services" className="py-6 border-b border-gray-200 scroll-mt-24">
            ...
            <section id="intellectual-property" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">INTELLECTUAL PROPERTY RIGHTS</h2>
              <div className="text-gray-700 space-y-4">
                <h3 className="text-lg font-medium text-gray-900 mb-2">Our intellectual property</h3>
                <p>
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2 mt-6">Your use of our Services</h3>
                <p>
            ...
            <section id="user-representations" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">USER REPRESENTATIONS</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section id="purchases" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">PURCHASES AND PAYMENT</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section id="subscriptions" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">SUBSCRIPTIONS</h2>
              <div className="text-gray-700 space-y-4">
                <h3 className="text-lg font-medium text-gray-900 mb-2">Billing and Renewal</h3>
                <p>
                  Your subscription will continue and automatically renew unless cancelled . You consent to our charging your payment method on a recurring basis without requiring your prior approval for each recurring charge, until such time as you cancel the applicable order. The length of your billing cycle is monthly as well as annually .
                </p>
                <h3 className="text-lg font-medium text-gray-900 mb-2 mt-6">Free Trial</h3>
                <p>
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2 mt-6">Cancellation</h3>
                <p>
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2 mt-6">Fee Changes</h3>
                <p>
            ...
            <section id="prohibited-activities" className="py-6 border-b border-gray-200 scroll-mt-24">
            ...
            <section id="user-contributions" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">USER GENERATED CONTRIBUTIONS</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section id="contribution-license" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">CONTRIBUTION LICENCE</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section id="services-management" className="py-6 border-b border-gray-200 scroll-mt-24">
            ...
            <section id="privacy-policy" className="py-6 border-b border-gray-200 scroll-mt-24">
            ...
            <section id="term-termination" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">TERM AND TERMINATION</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section id="modifications" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">MODIFICATIONS AND INTERRUPTIONS</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section id="governing-law" className="py-6 border-b border-gray-200 scroll-mt-24">
            ...
            <section id="dispute-resolution" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">DISPUTE RESOLUTION</h2>
              <div className="text-gray-700 space-y-4">
                <h3 className="text-lg font-medium text-gray-900 mb-2">Binding Arbitration</h3>
                <p>
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2 mt-6">Restrictions</h3>
                <p>
                  The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilise class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
                </p>
                <h3 className="text-lg font-medium text-gray-900 mb-2 mt-6">Exceptions to Arbitration</h3>
                <p>
            ...
            {/* Corrections Section */}
            <section id="corrections" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">CORRECTIONS</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            {/* Disclaimer Section */}
            <section id="disclaimer" className="py-6 border-b border-gray-200 scroll-mt-24">
            ...
            <section id="liability" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">LIMITATIONS OF LIABILITY</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section id="indemnification" className="py-6 border-b border-gray-200 scroll-mt-24">
            ...
            {/* User Data Section */}
            <section id="user-data" className="py-6 border-b border-gray-200 scroll-mt-24">
            ...
            <section id="communications" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section id="miscellaneous" className="py-6 border-b border-gray-200 scroll-mt-24">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">MISCELLANEOUS</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            {/* Contact Us Section */}
            <section id="contact" className="py-6 border-b border-gray-200 scroll-mt-24">
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-6 right-6 p-3 rounded-full bg-blue-600 text-white shadow-lg transition-opacity duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
