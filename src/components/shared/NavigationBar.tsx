...
function NavigationBar() {
  ...
  const products = [
    ...
    { name: 'V11-Conect', image: '/assets/img/v11-conect.png', link: 'products/coming-soon' },
    { name: 'V11-Queueing System', image: '/assets/img/v11-queue.png', link: 'products/coming-soon' },
    { name: 'V11-Ticket System', image: '/assets/img/v11-ticket.png', link: 'products/coming-soon' }
  ];
