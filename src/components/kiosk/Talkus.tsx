            ...
            <div className="bg-gradient-to-br from-teal-700 to-teal-900 rounded-2xl p-8 text-white shadow-2xl transform hover:rotate-1 transition-all duration-300 relative z-10">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {['Self Ordering Kiosk', 'Orders go to Kitchen instantly', 'Intergrated payments','Instant reciept printing','24/7 Zero downtime','Ease your customers Experience','All on One Solution'].map((item, index) => (
                    <div 
                      key={index}
