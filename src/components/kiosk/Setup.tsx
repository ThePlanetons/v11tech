  ...
  return (
    <div className="min-h-screen pt-10 bg-white">
      <div className="relative overflow-hidden px-24">
        ...
        <div className="absolute right-0 top-40 w-64 h-64 opacity-20">
        ...
        <div className="container mx-auto px-4 pt-6">
          <div className="text-center">
            <p className="text-green-500 font-medium mb-4">Grow Your Business With V11 KSSS</p>
            <h2 className="text-4xl md:text-5xl text-gray-800 v11-roboto tracking-wide font-bold">
              Delightfully Simple And Deceptively
            </h2>
            <h2 className="text-4xl md:text-5xl v11-roboto tracking-wide font-bold mb-10">
        ...
        <div className="container mx-auto px-4 pb-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, idx) => (
              <div key={idx} className="bg-white p-6 rounded-lg shadow-lg flex flex-col h-full">
                <div className="mb-4 flex items-center justify-center">
                  {feature.icon}
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">{feature.title}</h3>
                <p className="text-gray-600 mb-4 flex-grow">{feature.description}</p>
                <a href="#" className="mt-auto inline-flex items-center font-medium">
                  <span className="text-green-500">Learn More</span> <ArrowUpRight className="ml-1 w-4 h-4 text-green-500" />
                </a>
              </div>
            ))}
          </div>
