...
const V11QRLanding: React.FC = () => {
  ...
  // Create background bubbles on component mount
  useEffect(() => {
    const bgAnimation = document.getElementById("bg-animation");
    if (!bgAnimation) return;

    // Clear existing bubbles (for hot reloads)
    ...
    for (let i = 0; i < bubbleCount; i++) {
      ...
      bubble.className = "absolute rounded-full bg-green-400 opacity-100";
  ...
  return (
    <div className="bg min-h-screen py-16 relative overflow-hidden">
      {/* Background animation */}
      <div id="bg-animation" className="fixed inset-0 z-0 opacity-10"></div>
      ...
      <div className="container mx-auto px-4 z-10 relative">
        ...
        >
          {serviceItems.map((item, index) => (
            ...
            >
              <div className="mr-4 text-green-400 transform transition-all duration-500 group-hover:text-green-600 group-hover:scale-95 group-hover:-rotate-6">
